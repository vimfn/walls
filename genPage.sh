...
do
  ...
  do
    ...
    <img loading=\"lazy\" src=\"$wallpaper\" alt="$wallpaper" width=\"100\"></a>" >> ./index.html
  done
...
<p> I want to keep this site as simple as possible, but if you are the creator of any of these images and you want acknowledgment I will happily add a section with your name. Just open an issue <a href=\"https://github.com/its-ag/Wallpapers/issues\">here</a>.</p>
